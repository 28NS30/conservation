...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <html lang="zh-Hant-TW">
      <body style={{ background: "#020617", color: "#e2e8f0", fontFamily: "system-ui", padding: "3rem 1rem", textAlign: "center" }}>
        ...
        <button
          onClick={reset}
          style={{ marginTop: "1.25rem", background: "#10b981", color: "#020617", border: 0, borderRadius: 999, padding: ".45rem 1.1rem", fontSize: ".8rem", fontWeight: 600 }}
        >
          重試 · Retry
        </button>
      </body>
