  ...
  return (
    <Page>
      ...
      {/* As many rows as the page asks for, not a tidy dozen.
          The directory requests 80 (page.tsx), so twelve placeholders stood in
          for roughly 2,400px of list that was about to arrive — and when it
          did, everything below jumped. Measured on production, not inferred:
          CLS 0.0633 against a 0.05 budget, one shift at ~960ms, and the
